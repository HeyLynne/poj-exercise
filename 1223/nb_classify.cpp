...
void print_help() {
    cout << "\nOpenPR-NB classification module, " << VERSION << ", " << VERSION_DATE << "\n\n"
...
int main(int argc, char *argv[])
{
    ...
    float acc= nb.classify_test_data(test_file, output_file, event_model, output_format);
